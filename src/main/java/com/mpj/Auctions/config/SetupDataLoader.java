...
import com.mpj.Auctions.repository.PrivilegeRepository;
import com.mpj.Auctions.repository.RoleRepository;
...
public class SetupDataLoader implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(final ContextRefreshedEvent event) {
        ...
        // == create initial user
        //createUserIfNotFound("phuochoan1999qng@gmail.com", "PHUOC HOAN", "NGUYEN", "test", Arrays.asList(userRole));
        createUserIfNotFound("test@test.com", "Test", "Test", "test", Arrays.asList(userRole));
        alreadySetup = true;
    }
