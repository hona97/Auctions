package com.mpj.Auctions.event.listener;
...
public class RegistrationListener implements
    ...
    private void confirmRegistration(final OnRegistrationCompleteEvent event) {
        ...
        final VerificationToken token = userService.createVerificationToken(user);

        emailSender.send(
                user.getEmail(),
                constructEmailMessage(user.getFirstName(), event.getAppUrl() + "/registrationConfirm?token=" + token.getToken()));
    }

    private String constructEmailMessage(String name, String link) {
